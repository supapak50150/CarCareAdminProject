<div class="row">
  ...
  <?php
    ...
    <a type="button" class="btn btn-success" href="m_carFinishWash.php">รอชำระเงิน
      <span class="badge badge-light"><?= $total_cart_items3; ?></span>
    </a>
    <a type="button" class="btn btn-light" href="m_carAllOrders.php">รับรถ</a>
    <a class="btn btn-outline-dark" href="../service-status.php">ไปยังเว็บไซต์</a>
  </div>