...
<section class="content">
  ...
  <div class="card-body">
        ...
        <!-- Stat col -->
        <div class="col-md-12">
          <p class="h3"><strong>รายการที่..กำลังดำเนินการ</strong></p>
          <hr>
          <!-- Stat table-->
              ...
              ?>
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a class="btn btn-success btn-md" href="u_carWashing_update_stmt.php?order_id=<?= $row['order_id']; ?>" onclick="return confirm('ยืนยันการปรับสถานะเป็นดำเนินการเสร็จแล้ว รอชำระเงิน !!');">
                      เสร็จแล้ว
                    </a>
                  </td>
                  <td class="text-center">
