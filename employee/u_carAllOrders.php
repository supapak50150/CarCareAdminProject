...
<section class="content">
  ...
  <div class="card-body">
    ...
    <div class="col-md-12">
      <p class="h4 text-center m-2"><strong>รายการทั้งหมด</strong></p>
      <!-- Stat table-->
      <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
        <thead>
          <tr role="row" class="h6 text-center">
            ...
            <th tabindex="0" rowspan="1" colspan="1" style="width: 9%;">เวลา</th>
            <th tabindex="0" rowspan="1" colspan="1" style="width: 10%;">เจ้าหน้าที่</th>
