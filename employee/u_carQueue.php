...
<section class="content">
  ...
  <div class="card-body bg-white">
        ...
        <!-- Stat col -->
        <div class="col-md-12">
          <p class="h3"><strong>รายการที่..รอคิวรับบริการ</strong></p>
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
              <tr role="row" class="h6 text-center">
                <th tabindex="0" rowspan="1" colspan="1" style="width: 10%;">รหัสออเดอร์</th>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <i class="fas fa-print"></i> ใบรับรถ</a>
                  </td>
                  <td class="text-center">
                    <input hidden value="<?= $row['order_id']; ?>">
                    <a class="btn btn-warning btn-md" href="u_carQueue_update_stmt.php?order_id=<?= $row['order_id']; ?>" onclick="return confirm('ยืนยันการปรับสถานะเป็นกำลังดำเนินการ !!');">
                      ดำเนินการ
                    </a>
                  </td>
                  <td class="text-center">
