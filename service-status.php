...
<body>
    ...
    <div class="container">
        ...
        <div class="transbox text-dark p-4 mb-2">
        ...
        <div class="container p-4">
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <p id="status" class="p-3 mb-2  text-white text-center bg-primary">สถานะรถที่รับบริการ</p>
                ...
                <div id="contact" class="col-md-6 col-12 ">
                    ...
                    <!---start contact--->
                    <div class="container  ">
                        <h5 class="p-3 mb-2  text-white text-center bg-success">
